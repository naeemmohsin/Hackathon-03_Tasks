...
import NB_HP from "./components/nB_HP";
  ...
  return (
      ...
      <div className= "container" >
        ...
        <div className=" w-[472px] h-[356px] ml-[50px] text-white">
          ...
          <Link href="/Menu"><button className="w-[190px] h-[60px] text-white border rounded-[30px]
                                     border-[#FF9F0D] bg-[#FF9F0D]">See Menu</button>
           </Link>
